...
type Pole = "E" | "P" | "I" | "S" | "D" | "X" | "C" | "R" | "N" | "A";
type Axis = "vision" | "build" | "market" | "growth" | "tech";
...
// ─── Answer Scores Map ───
// Maps (questionId, optionLabel) → ScoreEntry[]

const answerScores: Record<number, Record<string, ScoreEntry[]>> = {
  // Axis 1: Vision (E vs P)
  1: {
    A: [{ pole: "E", axis: "vision", points: 3 }],
    B: [{ pole: "E", axis: "vision", points: 1 }],
    C: [{ pole: "P", axis: "vision", points: 1 }],
    D: [{ pole: "P", axis: "vision", points: 3 }],
  },
  2: {
    A: [{ pole: "E", axis: "vision", points: 3 }],
    B: [{ pole: "E", axis: "vision", points: 1 }],
  ...
  // Axis 2: Build (I vs S)
  4: {
    A: [{ pole: "I", axis: "build", points: 3 }],
    B: [{ pole: "I", axis: "build", points: 1 }],
    C: [{ pole: "S", axis: "build", points: 1 }],
    D: [{ pole: "S", axis: "build", points: 3 }],
  },
  5: {
    A: [{ pole: "I", axis: "build", points: 3 }],
    B: [{ pole: "I", axis: "build", points: 1 }],
  ...
  // Axis 3: Market (D vs X)
  7: {
    A: [{ pole: "D", axis: "market", points: 3 }],
    B: [{ pole: "D", axis: "market", points: 1 }],
    C: [{ pole: "X", axis: "market", points: 1 }],
    D: [{ pole: "X", axis: "market", points: 3 }],
  },
  8: {
    A: [{ pole: "D", axis: "market", points: 3 }],
    B: [{ pole: "D", axis: "market", points: 1 }],
  ...
  // Axis 4: Growth (C vs R)
  10: {
    A: [{ pole: "C", axis: "growth", points: 3 }],
    B: [{ pole: "C", axis: "growth", points: 1 }],
    C: [{ pole: "R", axis: "growth", points: 1 }],
    D: [{ pole: "R", axis: "growth", points: 3 }],
  },
  11: {
    A: [{ pole: "C", axis: "growth", points: 3 }],
    B: [{ pole: "C", axis: "growth", points: 1 }],
  ...
  // Axis 5: Tech (N vs A)
  13: {
    A: [{ pole: "N", axis: "tech", points: 3 }],
    B: [{ pole: "N", axis: "tech", points: 1 }],
    C: [{ pole: "A", axis: "tech", points: 1 }],
    D: [{ pole: "A", axis: "tech", points: 3 }],
  },
  14: {
    A: [{ pole: "N", axis: "tech", points: 3 }],
    B: [{ pole: "N", axis: "tech", points: 1 }],
  ...
  16: {
    A: [{ pole: "E", axis: "vision", points: 3 }, { pole: "I", axis: "build", points: 3 }],
    B: [{ pole: "E", axis: "vision", points: 1 }, { pole: "I", axis: "build", points: 1 }],
    C: [{ pole: "P", axis: "vision", points: 1 }, { pole: "S", axis: "build", points: 1 }],
    D: [{ pole: "P", axis: "vision", points: 3 }, { pole: "S", axis: "build", points: 3 }],
  },
  17: {
    A: [{ pole: "D", axis: "market", points: 3 }, { pole: "C", axis: "growth", points: 3 }],
    B: [{ pole: "D", axis: "market", points: 1 }, { pole: "R", axis: "growth", points: 1 }],
    C: [{ pole: "X", axis: "market", points: 1 }, { pole: "C", axis: "growth", points: 1 }],
    D: [{ pole: "X", axis: "market", points: 3 }, { pole: "R", axis: "growth", points: 3 }],
  },
  18: {
    A: [{ pole: "N", axis: "tech", points: 3 }, { pole: "E", axis: "vision", points: 3 }],
    B: [{ pole: "N", axis: "tech", points: 1 }, { pole: "E", axis: "vision", points: 1 }],
    C: [{ pole: "A", axis: "tech", points: 1 }, { pole: "P", axis: "vision", points: 1 }],
    D: [{ pole: "A", axis: "tech", points: 3 }, { pole: "P", axis: "vision", points: 3 }],
  },
};

// ─── Scoring Functions ───

function calculateScores(answers: { questionId: number; optionLabel: string }[]): AxisScores {
  ...
  for (const answer of answers) {
    const questionScores = answerScores[answer.questionId]?.[answer.optionLabel];
...
function getDNACode(scores: AxisScores): string {
...
function getRawCode(scores: AxisScores): string {
  const vision = scores.vision.E >= scores.vision.P ? "E" : "P";
  const build = scores.build.I >= scores.build.S ? "I" : "S";
  const market = scores.market.D >= scores.market.X ? "D" : "X";
  const growth = scores.growth.C >= scores.growth.R ? "C" : "R";
...
// ─── DNA Result Classification ───

function getDNAResult(scores: AxisScores): DNAResult {
...
const axisLabels: { key: Axis; name: string; poleA: string; codeA: string; poleB: string; codeB: string }[] = [
...
function getAxisResults(scores: AxisScores): AxisResult[] {
  return axisLabels.map((meta) => {
    const axisScore = scores[meta.key];
    ...
    const description = axisDescriptions[meta.key]?.[dominantCode] || "";
...
export function scoreQuiz(answers: { questionId: number; optionLabel: string }[]): {
  result: DNAResult;
  ...
  return {
    result,
    axisResults,
    genomeCode: getDNACode(scores),
    genomeName: result.name,
    axisScores: scores,
  };
}
